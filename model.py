...
class RING_EXCHANGE(CouplingModel,MPOModel):
    ...
    def __init__(self, model_params):
        ...
        # Heisenberg term
        s = np.sin(phi*np.pi)
        self.add_coupling( s, 0, 'Sx', 0, 'Sx', [1, 0])
        self.add_coupling( s, 0, 'Sy', 0, 'Sy', [1, 0])
        self.add_coupling( s, 0, 'Sz', 0, 'Sz', [1, 0])
        self.add_coupling( s, 0, 'Sx', 0, 'Sx', [0, 1])
        self.add_coupling( s, 0, 'Sy', 0, 'Sy', [0, 1])
        self.add_coupling( s, 0, 'Sz', 0, 'Sz', [0, 1])
        
        # Ring-exchange term
        c = np.cos(phi*np.pi)
        # (S_{i} . S_{i+y}) (S_{i+x} . S_{i+x+y}) 
        self.add_multi_coupling( c , [('Sx', [0,0], 0), ('Sx', [0,1], 0), ('Sx', [1,0], 0), ('Sx', [1,1], 0)])
        self.add_multi_coupling( c , [('Sy', [0,0], 0), ('Sy', [0,1], 0), ('Sx', [1,0], 0), ('Sx', [1,1], 0)])
        self.add_multi_coupling( c , [('Sz', [0,0], 0), ('Sz', [0,1], 0), ('Sx', [1,0], 0), ('Sx', [1,1], 0)])
        self.add_multi_coupling( c , [('Sx', [0,0], 0), ('Sx', [0,1], 0), ('Sy', [1,0], 0), ('Sy', [1,1], 0)])
        self.add_multi_coupling( c , [('Sy', [0,0], 0), ('Sy', [0,1], 0), ('Sy', [1,0], 0), ('Sy', [1,1], 0)])
        self.add_multi_coupling( c , [('Sz', [0,0], 0), ('Sz', [0,1], 0), ('Sy', [1,0], 0), ('Sy', [1,1], 0)])
        self.add_multi_coupling( c , [('Sx', [0,0], 0), ('Sx', [0,1], 0), ('Sz', [1,0], 0), ('Sz', [1,1], 0)])
        self.add_multi_coupling( c , [('Sy', [0,0], 0), ('Sy', [0,1], 0), ('Sz', [1,0], 0), ('Sz', [1,1], 0)])
        self.add_multi_coupling( c , [('Sz', [0,0], 0), ('Sz', [0,1], 0), ('Sz', [1,0], 0), ('Sz', [1,1], 0)])

        # (S_{i} . S_{i+x}) (S_{i+y} . S_{i+x+y}) 
        self.add_multi_coupling( c , [('Sx', [0,0], 0), ('Sx', [1,0], 0), ('Sx', [0,1], 0), ('Sx', [1,1], 0)])
        self.add_multi_coupling( c , [('Sy', [0,0], 0), ('Sy', [1,0], 0), ('Sx', [0,1], 0), ('Sx', [1,1], 0)])
        self.add_multi_coupling( c , [('Sz', [0,0], 0), ('Sz', [1,0], 0), ('Sx', [0,1], 0), ('Sx', [1,1], 0)])
        self.add_multi_coupling( c , [('Sx', [0,0], 0), ('Sx', [1,0], 0), ('Sy', [0,1], 0), ('Sy', [1,1], 0)])
        self.add_multi_coupling( c , [('Sy', [0,0], 0), ('Sy', [1,0], 0), ('Sy', [0,1], 0), ('Sy', [1,1], 0)])
        self.add_multi_coupling( c , [('Sz', [0,0], 0), ('Sz', [1,0], 0), ('Sy', [0,1], 0), ('Sy', [1,1], 0)])
        self.add_multi_coupling( c , [('Sx', [0,0], 0), ('Sx', [1,0], 0), ('Sz', [0,1], 0), ('Sz', [1,1], 0)])
        self.add_multi_coupling( c , [('Sy', [0,0], 0), ('Sy', [1,0], 0), ('Sz', [0,1], 0), ('Sz', [1,1], 0)])
